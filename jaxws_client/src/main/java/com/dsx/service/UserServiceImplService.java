 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://impl.service.dsx.com/", wsdlLocation = "http://localhost:8080/ws/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.dsx.com/", "UserServiceImplService");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://impl.service.dsx.com/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.dsx.com/", "UserServiceImplPort"), UserService.class, features);
    }
